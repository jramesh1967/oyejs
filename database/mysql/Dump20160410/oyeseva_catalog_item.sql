...
CREATE TABLE `catalog_item` (
  ...
  `idcatalog_item` int(11) NOT NULL,
  PRIMARY KEY (`catalog_idcatalog`,`idcatalog_item`),
  UNIQUE KEY `UK_c1kjsceetsr9mptvbx9ko5q5a` (`catalog_idcatalog`),
  UNIQUE KEY `UK_pdh2t4fn6hci9g4cep7crsjwc` (`idcatalog_item`),
  CONSTRAINT `FK_c1kjsceetsr9mptvbx9ko5q5a` FOREIGN KEY (`catalog_idcatalog`) REFERENCES `catalog` (`idcatalog`)
